...
import styles from "../../../styles/generics/editable-field-components/metaform-table-field-component";
...
export default withStyles(styles)(MetaformTableFieldComponent);