...
import styles from "../../../styles/generics/editable-field-components/metaform-date-field-component";
...
/**
 * Component for Metaform editable date field
 */
...
export default withStyles(styles)(MetaformDateFieldComponent);