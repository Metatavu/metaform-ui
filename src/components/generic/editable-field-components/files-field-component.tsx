...
import styles from "../../../styles/generics/editable-field-components/metaform-files-field-component";
...
/**
 * Component for Metaform editable files field
 */
...
export default withStyles(styles)(MetaformFilesFieldComponent);