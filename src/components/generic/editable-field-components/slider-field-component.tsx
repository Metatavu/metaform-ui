...
import styles from "../../../styles/generics/editable-field-components/metaform-slider-field-component";
...
/**
 * Component for Metaform editable slider field
 */
...
export default withStyles(styles)(MetaformSliderFieldComponent);