...
export class ExportThemeFilesApi extends runtime.BaseAPI {
    ...
    async createExportThemeFileRaw(requestParameters: CreateExportThemeFileRequest): Promise<runtime.ApiResponse<ExportThemeFile>> {
        ...
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling createExportThemeFile.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/exportThemes/{exportThemeId}/files`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"exportThemeId"}}`, encodeURIComponent(String(requestParameters.exportThemeId))),
            method: 'POST',
    ...
    async deleteExportThemeFileRaw(requestParameters: DeleteExportThemeFileRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling deleteExportThemeFile.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/exportThemes/{exportThemeId}/files/{exportThemeFileId}`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"exportThemeId"}}`, encodeURIComponent(String(requestParameters.exportThemeId))).replace(`{${"exportThemeFileId"}}`, encodeURIComponent(String(requestParameters.exportThemeFileId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async findExportThemeFileRaw(requestParameters: FindExportThemeFileRequest): Promise<runtime.ApiResponse<ExportThemeFile>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling findExportThemeFile.');
        }
    ...
    async listExportThemeFilesRaw(requestParameters: ListExportThemeFilesRequest): Promise<runtime.ApiResponse<Array<ExportThemeFile>>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling listExportThemeFiles.');
        }
    ...
    async updateExportThemeFileRaw(requestParameters: UpdateExportThemeFileRequest): Promise<runtime.ApiResponse<ExportThemeFile>> {
        ...
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling updateExportThemeFile.');
        }
