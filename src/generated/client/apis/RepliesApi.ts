...
export class RepliesApi extends runtime.BaseAPI {
    ...
    async _exportRaw(requestParameters: ExportRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling _export.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/metaforms/{metaformId}/export`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"metaformId"}}`, encodeURIComponent(String(requestParameters.metaformId))),
            method: 'GET',
    ...
    async createReplyRaw(requestParameters: CreateReplyRequest): Promise<runtime.ApiResponse<Reply>> {
        ...
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling createReply.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/metaforms/{metaformId}/replies`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"metaformId"}}`, encodeURIComponent(String(requestParameters.metaformId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
    ...
    async deleteReplyRaw(requestParameters: DeleteReplyRequest): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling deleteReply.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/metaforms/{metaformId}/replies/{replyId}`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"metaformId"}}`, encodeURIComponent(String(requestParameters.metaformId))).replace(`{${"replyId"}}`, encodeURIComponent(String(requestParameters.replyId))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async findReplyRaw(requestParameters: FindReplyRequest): Promise<runtime.ApiResponse<Reply>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling findReply.');
        }
    ...
    async listRepliesRaw(requestParameters: ListRepliesRequest): Promise<runtime.ApiResponse<Array<Reply>>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling listReplies.');
        }
    ...
    async replyExportRaw(requestParameters: ReplyExportRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling replyExport.');
        }
        ...
        const response = await this.request({
            path: `/realms/{realmId}/metaforms/{metaformId}/replies/{replyId}/export`.replace(`{${"realmId"}}`, encodeURIComponent(String(requestParameters.realmId))).replace(`{${"metaformId"}}`, encodeURIComponent(String(requestParameters.metaformId))).replace(`{${"replyId"}}`, encodeURIComponent(String(requestParameters.replyId))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        });
    ...
    async updateReplyRaw(requestParameters: UpdateReplyRequest): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters.realmId === null || requestParameters.realmId === undefined) {
            throw new runtime.RequiredError('realmId','Required parameter requestParameters.realmId was null or undefined when calling updateReply.');
        }
